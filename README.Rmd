...
Mind you, these, and numerous other [hapless results](https://www.nbcnews.com/tech/tech-news/google-ai-im-feeling-depressed-cheese-not-sticking-to-pizza-error-rcna153301) (as of May, 2023) are produce by AI _after_ Google has already spent tens of billions of dollars on the technology [@vynck_after_2024]. To what extent can more money improve AI? Probably not by much, since the key constraint is the amount of data available for training.
