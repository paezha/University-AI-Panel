...
I suggest that universities should avoid the mistakes of the media, an industry that has innovated itself [out of the trust of the public](https://reutersinstitute.politics.ox.ac.uk/news/julia-angwin-fears-public-sphere-about-get-worse-ai-makes-it-easier-flood-zone-misinformation) (also see the "pivot-to-video" and how tech companies suckered many media companies, including ). Tech corporations (or least ways some of them), can still hope to recoup some of their investment in AI. But a university gambles its most important asset when betting on AI: its reputation as a place were knowledge is created, and as a custodian of knowledge. AIs already have a reputation for producing mis- and disinformation--from the very titans of the field^[Google could not care less about its reputation. It is [too big to care](https://pluralistic.net/2024/04/04/teach-me-how-to-shruggie/#kagi).] to the unaware^[], and beyond, to bad-faith actors. In my view, there are no efficiencies, no promises of future excellence, that can compensate the risk of ruining an institutions reputation.
